...
%
%
%IACS=5.8001e7; %valor 100% da condutividade
IACS=5.71e7;
...
al.rho=1/(0.61*IACS); % 61% IACS (Resistividade)
%
%
%Aço :
%7 unidades
...
geo_fase=[0 0;-d d; d d;-d -d; d -d]; % geometria de uma fase (Dentro do FIO)
geo_linha=[-3 0;0 0;3 0]; % geometria entre fases (Da LINHA)
